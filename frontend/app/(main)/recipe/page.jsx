                ...
                <div key={category} className="mb-6 last:mb-0">
                  ...
                  <ul className="space-y-2">
                    {items.map((ingredient, i) => (
                      <li
                        key={i}
                        className="flex justify-between items-start gap-3 text-stone-700 py-2 border-b border-stone-100 last:border-0"
                      >
                        <span className="flex-1 min-w-0">{ingredient.item}</span>
                        <span className="font-bold text-orange-600 text-sm text-right shrink-0 max-w-[60%] break-words">
                          {ingredient.amount}
                        </span>
                      </li>
                    ))}
